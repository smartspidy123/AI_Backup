...
try:
    ...
    from shared.schemas import TaskRequest, TaskComplexity
    from modules.ai_routing.router import AIRouter
except ImportError:
    import logging
    def get_logger(name):
    ...
    def _call_ai(self, prompt: str, system_prompt: str = None) -> Optional[str]:
        ...
        try:
            ...
            task_request = TaskRequest(
                prompt=prompt,
                system_prompt=system_prompt or PromptBuilder.SYSTEM_PROMPT,
